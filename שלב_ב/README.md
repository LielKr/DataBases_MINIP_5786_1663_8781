...
ביצענו עדכון של מחיר וסטטוס עבור הזמנה מספר 1010 בתוך בלוק טרנזקציה, ראינו שהנתונים השתנו זמנית, ולאחר מכן ביצענו ROLLBACK שהחזיר את המצב לקדמותו.
...
ביצענו עדכון סטטוס להזמנה מספר 2000, בדקנו את השינוי ושמרנו אותו לצמיתות בדיסק באמצעות פקודת COMMIT.
